	...
	<form method="post">
		...
		<div class="body white-bg">
			...
			<div class="form-group">
				<input class="form-control" placeholder="Correo" name="username" type="text" autofocus value="<?= set_value('username') ?>">
			</div>
			<div class="form-group">
			...
			<div class="checkbox">
				...
				<span class="pull-right">
					<label>
						<a href="<?= base_url('reset/index') ?>"> Restablecer contraseña</a>
					</label>
				</span>
			</div>
